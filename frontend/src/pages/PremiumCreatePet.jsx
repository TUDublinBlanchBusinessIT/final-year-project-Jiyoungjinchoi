...
export default function PremiumCreatePet() {
  ...
  return (
    <div className="ppf-page">
      ...
      <header className="ppf-topbar">
        ...
        <div className="ppf-title-chip">Create Premium Pet</div>
      ...
      <section className="ppf-hero">
        <div>
          <span className="ppf-badge">PREMIUM PROFILE SETUP</span>

          <h2>Create Pet Profile</h2>

          <p>
            Add your pet’s details, health information, reminders, lifestyle notes,
            and safety details in one premium Pawfection profile.
          </p>
        </div>
      ...
      <main className="ppf-layout">
        <aside className="ppf-side">
          <section className="ppf-card">
            <h3>Pet Preview</h3>
            <p className="ppf-sub">This updates while you complete the form.</p>
          ...
          <section className="ppf-card">
            ...
            <div className="ppf-tip-card">
              ...
              <p>
                Adding markings, allergies, and microchip details makes the profile
                more useful for reminders and Lost & Found.
              </p>
            </div>
          </section>
        </aside>
        ...
        <form onSubmit={submit} className="ppf-form-card">
          ...
          <div className="ppf-actions-row">
            <button className="ppf-btn ppf-btn-primary" type="submit" disabled={loading}>
    ...
    <>
      <div className="ppf-section">
        <div className="ppf-section-head">
          <h2>Basic Info</h2>
          <p>Required fields to create a profile.</p>
        </div>
