...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/premium/insights', [PremiumInsightsController::class, 'index']);
    Route::get('/pets/{pet}/health-logs', [PetHealthLogController::class, 'index']);
    Route::post('/pets/{pet}/health-logs', [PetHealthLogController::class, 'store']);
